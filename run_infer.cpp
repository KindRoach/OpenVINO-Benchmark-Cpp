...
int infer_one_stream(vector<ov::Tensor> &outputs, ov::CompiledModel model, int sec, bool inference_only, bool ov_preprocess);
ov::Tensor infer_one_frame(ov::InferRequest infer_request, Mat frame, ov::element::Type input_type, ov::Shape input_shape);
